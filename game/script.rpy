...
### СЦЕНА 3: Встреча с одноклассницей ###
label scene_meeting:
    # show ars
    
    voice "Ой, Арсений! Привет!"
    ...
    autor "Она исчезает так же быстро, как появилась."
    
    inner "«Стихи не учила». Для неё это просто домашнее задание."
    inner "А для меня? Почему эти строки въелись в память?"
    inner "«Глаголом жги сердца людей»."
    inner "Разве можно учить это, как таблицу умножения? Это же огонь!"
