...
label scene_meeting:
    ...
    voice "Ой, [player_name]! Привет!"
    
    autor "Из толпы выныривает Катя — одноклассница, с которой они сидят через ряд."
    
    a "Привет, Кать. Ты чего так несёшься?" 
    
    voice "Опоздала! Представляешь? На литературу опоздала! А Марья Ивановна злющая сегодня?"
    
    a "Да нет, нормальная. Стихи читала. Пушкина." 
    
    voice "Ой, стихи... А я их не учила. Думала, спросят, а я... Ладно, побежала!"
    
    autor "Она уже хочет убежать, но вдруг останавливается."
    
    voice "Слушай... а ты стихи пишешь, да? Я слышала."
    ...
    menu:
        ...
        "Да, есть немного.":
            ...
            voice "Круто! А почитаешь как-нибудь? Мне правда интересно."
            a "Может быть."
            inner "Она попросила почитать. Кто-то всерьез интересуется моими каракулями?"
            
        "Нет, тебе послышалось.":
            $ doubt += 1
            $ total_choices += 1
            a "Да нет, это не мое. Так, балуюсь."
            voice "А, ну ладно. Показалось. Ладно, пока!"
...
label scene_park:
    ...
    inner "Зимой парк — как скелет лета. Видна суть."
    
    autor "На скамейке сидит незнакомый пожилой мужчина в старом пальто. Он читает."
    ...
    menu:
        ...
        "Подойти, спросить что читает.":
            ...
            stranger "Бродского. «Часть речи». А ты, юноша, видимо, пишешь?"
            a "С чего вы взяли?"
            stranger "Взгляд. Ты смотришь на снег не как все. Ты ищешь рифму к слову «белизна»."
            a "Тишина?"
            stranger "Хороший вариант. Но Бродский бы сказал «укор» или «поздно». Дерзай."
            autor "Незнакомец кивает и возвращается к книге."
            inner "«Белизна — укор». Надо запомнить."
            jump scene_home
...
label scene_night:
    ...
    menu:
        ...
        "Я хочу писать, несмотря ни на что.":
            ...
            "Ты пишешь то, что чувствуешь здесь и сейчас."
            jump ending
