...
define gui.accent_color = '#f5e7b9'
...
define gui.muted_color = '#230051'
define gui.hover_muted_color = '#15039a'
...
define gui.game_menu_background =  im.Scale("gui/main_menu.png", 1920, 1080)
